...
!jt  integer,  public :: ksponge_end       ! sponge is active k=1,ksponge_end
...
!jt  real(r8), public :: km_sponge_factor(PLEV) !scaling for molecular diffusion (when used as sponge)
